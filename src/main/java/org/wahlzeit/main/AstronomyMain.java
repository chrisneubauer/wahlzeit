 ...
 */
public class AstronomyMain extends ServiceMain {

	private static final Logger log = Logger.getLogger(AstronomyMain.class.getName());

	/**
	 *
	 */
	protected static AstronomyMain instance = new AstronomyMain();
	 ...
	 *
	 */
	public static AstronomyMain getInstance() {
		return instance;
	}
