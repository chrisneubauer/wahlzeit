...
/**
 * A simple ServletContextListener to startup and shutdown the Astronomy application.
 */
public class Astronomy extends Wahlzeit implements ServletContextListener {

	private static final Logger log = Logger.getLogger(Astronomy.class.getName());
